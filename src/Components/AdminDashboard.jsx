...
const AdminDashboard = () => {
  ...
  return (
    ...
    <div className="w-full mt-16  max-w-[90%] mx-auto my-6 border border-gray-300 rounded-lg p-6 bg-transparent">
      ...
      <div className="flex text-sm text-gray-500 mb-4">
        ...
        <div className="flex w-full">
          <p className="px-3 py-2 text-gray-400 border border-red-600 rounded-md font-medium hover:bg-sky-200 transition ml-auto dark:text-white dark:border-gray-500">
            Expired
          </p>
        </div>
      </div>
